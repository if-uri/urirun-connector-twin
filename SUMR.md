...
# code2llm | 18f 3618L | python:10,yaml:4,shell:2,json:1,toml:1 | 2026-06-27
# generated in 0.00s
...
PIPELINES[30]:
  ...
  [22] Src [flow_execute]: flow_execute
      PURITY: 100% pure
  [23] Src [flow_recall]: flow_recall
      PURITY: 100% pure
  [24] Src [flow_episode_run]: flow_episode_run
      PURITY: 100% pure
  [25] Src [flow_diagnose]: flow_diagnose
      PURITY: 100% pure
  [26] Src [monitor_event]: monitor_event
      PURITY: 100% pure
  [27] Src [bindings]: bindings
      PURITY: 100% pure
  [28] Src [manifest]: manifest
      PURITY: 100% pure
  [29] Src [main]: main
      PURITY: 100% pure
  [30] Src [get]: get
...
LAYERS:
  ...
  │ !! core                       733L  0C   34m  CC=20     ←0
  │ !! browser                    327L  0C   13m  CC=15     ←2
  │ prompt_plan                261L  0C   21m  CC=13     ←2
...
# code2llm/evolution | 104 func | 9f | 2026-06-27
# generated in 0.00s

NEXT[6] (ranked by impact):
  [1] !! SPLIT           urirun_connector_twin/core.py
      WHY: 733L, 0 classes, max CC=20
      EFFORT: ~4h  IMPACT: 14660

  [2] !  SPLIT-FUNC      flow_recall  CC=20  fan=16
